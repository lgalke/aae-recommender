...
ECON = pd.read_csv('Data/Economics/econbiz62k.tsv', sep='\t', dtype={'year':int})
PMCC = pd.read_csv('Data/PMC/citations_pmc.tsv', sep='\t', dtype={'year':int})
REUTERS = pd.read_csv('Data/Reuters/rv1.tsv', sep='\t', dtype={'year':int})
